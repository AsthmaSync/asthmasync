...
const GetTriggers = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-8">
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
                    <div className="flex items-center gap-3">
                        <FaExclamationTriangle className="text-2xl sm:text-3xl text-cyan-500" />
                        <div className="text-center sm:text-left">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-800">Triggers Log</h2>
                            <p className="text-gray-600 text-sm sm:text-base">Track and manage your asthma triggers</p>
                        </div>
                    </div>
                    <Link 
                        to="/triggers/add" 
            ...
            {/* Triggers Grid - Made responsive */}
            {triggers.length === 0 ? (
                <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                    <FaExclamationTriangle className="text-4xl sm:text-5xl text-gray-400 mx-auto mb-4" />
                    <p className="text-gray-500 text-base sm:text-lg">No triggers recorded yet.</p>
                    <Link 
                        to="/triggers/add"
