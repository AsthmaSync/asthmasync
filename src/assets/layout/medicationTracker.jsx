...
const MedicationTracking = () => {
  ...
  return (
    ...
    <div className="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md mt-10 mb-10 relative z-10">
      ...
      <div className="mb-6">
        ...
        <select
          ...
          className={`w-full mb-4 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 ${frequency === '' ? 'text-gray-400' : 'text-black'
            }`}
        >
        ...
        <input
          ...
          className="w-full mb-4 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 text-gray-400"
        />
        <input
          type="date"
        ...
        <select
          ...
          className={`w-full mb-4 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 ${purpose === '' ? 'text-gray-400' : 'text-black'
            }`}
        >
        ...
        <select
          ...
          className={`w-full mb-4 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 ${taken === '' ? 'text-gray-400' : 'text-black'
            }`}
        >
